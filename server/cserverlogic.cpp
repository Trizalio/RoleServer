    ...
    m_pOrm(pOrm)
{
    ...
    m_pOrm->insertLore(SLore("Задание для тестирования", "Одна из основных задач портала - слежение за Вашим состоянием, поэтому следующим заданием будет "
                     ...
                     "ячейки:"+sAirCellHash+" После активации кислородной ячейки проверьте свой статус и вернитесь на базу так же, как вышли с неё, "
                     "с помощью кода шлюза и взаимодействия с ним."
